export const translationsMap = {
    en: {
        ...
        productPage: {
            ...
            handlingTimeUndefined: 'Undefined handling time',
            handlingTimeImmediately: 'This item ships immediately upon receiving a clear payment',
    ...
    es: {
        ...
        productPage: {
            ...
            handlingTimeUndefined: 'Tiempo de manejo indefinido',
            handlingTimeImmediately: 'Este artículo se envía inmediatamente después de recibir un pago claro',
    ...
    fr: {
        ...
        productPage: {
            ...
            handlingTimeImmediately: 'Cet article est expédié immédiatement après réception d\'un paiement clair',
            handlingTime: 'Temps de manutention: ',
            handlingTimeUndefined: 'Temps de traitement non défini',
            condition: 'État: ',
            requiresImmediatePayment: 'Nécessite un paiement immédiat: ',
    ...
    it: {
        ...
        productPage: {
            ...
            isAuction: 'È un\'asta: ',
            handlingTimeUndefined: 'Tempo di movimentazione indefinito',
            handlingTime: 'Tempo di trattamento: ',
            handlingTimeImmediately: 'Questo articolo viene spedito immediatamente dopo aver ricevuto un pagamento chiaro',
    ...
    ga: {
        ...
        productPage: {
            ...
            handlingTimeUndefined: 'Am láimhseála neamhshainithe',
            handlingTimeImmediately: 'Tá an t-alt seo ag dul díreach tar éis íocaíocht shoiléir a fháil',
            condition: 'Coinníoll: ',
            requiresImmediatePayment: 'Éilíonn íocaíocht láithreach: ',
    ...
    pl: {
        ...
        productPage: {
            ...
            handlingTimeUndefined: 'Nieokreślony czas obsługi',
            handlingTimeImmediately: 'Produkt jest wysyłany natychmiast po otrzymaniu wyraźnej płatności',
            condition: 'Stan: ',
            requiresImmediatePayment: 'Wymaga natychmiastowej płatności: ',
    ...
    de: {
        ...
        productPage: {
            ...
            handlingTimeUndefined: 'Unbestimmte Bearbeitungszeit',
            handlingTimeImmediately: 'Dieser Artikel wird sofort nach Zahlungseingang versandt',
    ...
    sk: {
        ...
        productPage: {
            ...
            views: 'Názory',
            handlingTimeUndefined: 'Nedefinovaný čas manipulácie',
            viewShippingDetails: 'Zobraziť podrobnosti o preprave',
            isAuction: 'Je aukcia: ',
            handlingTime: 'Doba spracovania: ',
            handlingTimeImmediately: 'Táto položka sa ihneď po prijatí jasnej platby vypláca',
            condition: 'podmienka: ',
            requiresImmediatePayment: 'Vyžaduje okamžitú platbu: ',
    ...
    cs: {
        ...
        productPage: {
            ...
            handlingTimeUndefined: 'Nedefinovaná doba manipulace',
            handlingTimeImmediately: 'Tato položka je odeslána okamžitě po obdržení jasné platby',
