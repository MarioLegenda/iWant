        ...
        $this->entries = [
            [
                ...
                'values' => [
                    ...
                    'de' => ['maske', 'hülle', 'hulle', 'schützend', 'schutzend', 'schutz', 'beschützend', 'beschutzend', 'klingelzeichen', 'fassung', 'halter', 'abdeckung', 'deckel', 'umschlag', 'geldborse', 'geldbeutel', 'handtasche', 'Berührungsempfindlicher Bildschirm', 'beruhrungsempfindlicher bildschirm', 'schutz', 'beschützer', 'beschutzer', 'bildschirm', 'schirm', 'schale', 'hülle', 'hulle'],
                    'es' => ['máscara', 'mascara', 'mascarilla', 'careta', 'caja', 'protector', 'anillo', 'aro', 'soporte', 'cubrir', 'tapar', 'encubrir', 'bolso', 'pantalla táctil', 'pantalla tactil', 'lcd', 'pantalla', 'cáscara', 'cascara', 'funda', 'carcasa'],
                    'it' => ['custodia', 'maschera', 'cassa', 'protettivo', 'ring', 'supporto', 'ricoprire', 'borsa', 'borsetta', 'protettore', 'lcd', 'schermo', 'paravento', 'guscio'],
                    'pl' => ['maska', 'etui', 'skrzynka', 'ochronny', 'zabezpieczający', 'opiekuńczy', 'opiekunczy', 'pierścionek', 'pierscionek', 'uchwyt', 'podstawka', 'pokrywa', 'osłona', 'oslona', 'portmonetka', 'kiesa', 'torba', 'torebka', 'ekran dotykowy', 'protektor', 'lcd', 'ekran', 'powłoka', 'powloka'],
                ],
            ],
            [
                'reference' => 'samsung',
