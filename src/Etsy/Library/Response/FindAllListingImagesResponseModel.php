...
use App\Etsy\Library\Response\ResponseItem\ListingImagesResults;
...
class FindAllListingImagesResponseModel implements EtsyApiResponseModelInterface
{
    /**
    ...
    public function getResults(): ResultsInterface
    {
        if (!isset($this->responseObjects['results'])) {
            $this->responseObjects['results'] = new ListingImagesResults($this->responseData['results']);
        }
